...
(function () {
    ...
    function initSearchInstance(wrapper) {
        const input = wrapper.querySelector('.ss-search-input') || wrapper.querySelector('input[type="text"]');
        const resultsContainer = wrapper.querySelector('.ss-results-container');
        const hitsContainer = wrapper.querySelector('.ss-hits') || wrapper.querySelector('[id^="ss-hits"]') || wrapper.querySelector('.ss-hits');
        const facetsContainer = wrapper.querySelector('.ss-facets') || wrapper.querySelector('[id^="ss-facets"]') || wrapper.querySelector('.ss-facets');
        const loader = wrapper.querySelector('.ss-loader');
    ...
    document.querySelectorAll('.ss-wrapper').forEach(initSearchInstance);
